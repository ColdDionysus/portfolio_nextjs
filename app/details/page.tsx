...
export default function Details() {
    return (
        <>
        <Nav />
            <section className="text-white body-font overflow-hidden bg-gradient-to-br from-blue-500 to-teal-400">
                <div className="container px-5 py-24 mx-auto">
                    <div className="-my-8 divide-y-2 divide-gray-100">
                        <div className="py-8 flex flex-wrap md:flex-nowrap">
                            <div className="md:w-64 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
                                <span className="font-semibold title-font text-black">CATEGORY</span>
                                <span className="mt-1 text-gray-700 text-sm">12 Jun 2019</span>
                            </div>
